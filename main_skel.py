...
def main():
    ...
    channel_radii_images = circular_filter(torch.clamp(image_data, 0, 1), filter).cpu().numpy()
...
# python3 main_skel.py --image_path /Users/balakadutta/PycharmProjects/Project_skeleton/H02.jpg --image_truth_path /Users/balakadutta/PycharmProjects/Project_skeleton/test.png --max_radius 7 --show
